...
export const metadata: Metadata = {
  ...
  description:
    "Software su misura, AI e automazione come spesa ammissibile sui bandi di digitalizzazione del Piemonte (Voucher Digitalizzazione PMI 2026, Digitalizzazione e Efficientamento 2026). Individuiamo il bando e ti accompagniamo lungo tutto il grant, inclusi i bandi europei come Horizon.",
  alternates: {
